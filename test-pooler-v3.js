...
async function test() {
  ...
  // No sslmode in URL - use ssl option directly
  const poolerUrl = 'postgresql://postgres.' + projectRef + ':' + password + '@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres';
  
  console.log('Testing pooler connection without sslmode in URL...');
